This fork exists to revert a change that was made which makes the library incompatible with Discogs API. See: https://github.com/jrconlin/oauthsimple/issues/22
PHP is working with Discogs API now.  I will try to update the other libs as soon as possible.
